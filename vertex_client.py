"""
Vertex AI Client for EcoGridIQ
...
class VertexAIClient:
    ...
    async def generate_chat_response(
        ...
        try:
            ...
            # Create prompt
            prompt = f"""
You are an AI energy assistant for EcoGridIQ. Help users understand their energy consumption and provide actionable recommendations.
