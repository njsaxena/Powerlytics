...
# Powerlytics Frontend Deployment Script
set -e

# Configuration
PROJECT_ID=${GOOGLE_CLOUD_PROJECT:-"powerlytics"}
BUCKET_NAME="$PROJECT_ID-powerlytics-frontend"
BACKEND_URL=${BACKEND_URL:-"https://powerlytics-backend-uc.a.run.app"}

echo "🌐 Deploying Powerlytics Frontend..."
