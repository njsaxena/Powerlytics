...
# EcoGridIQ Backend Deployment Script
set -e

# Configuration
PROJECT_ID=${GOOGLE_CLOUD_PROJECT:-"ecogrid-iq"}
REGION="us-central1"
SERVICE_NAME="ecogrid-backend"
IMAGE_NAME="gcr.io/$PROJECT_ID/$SERVICE_NAME"

echo "🚀 Deploying EcoGridIQ Backend to Cloud Run..."
...
gcloud run deploy $SERVICE_NAME \
    ...
    --cpu 2 \
    --max-instances 10 \
    --set-env-vars "GOOGLE_CLOUD_PROJECT=$PROJECT_ID,BIGQUERY_DATASET=ecogrid_dwh,VERTEX_AI_LOCATION=$REGION"
