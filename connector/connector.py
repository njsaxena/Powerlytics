"""
Powerlytics Fivetran Custom Connector
...
class PowerlyticsConnector:
    """
    Fivetran Custom Connector for Powerlytics energy data
    """
    ...
    def spec(self) -> Dict[str, Any]:
        ...
        """
        return {
            "documentation_url": "https://github.com/powerlytics/connector",
...
def main():
    ...
    command = sys.argv[1]
    connector = PowerlyticsConnector()
